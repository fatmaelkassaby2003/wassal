...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('front/css/select_res.css') }}">
</head>
...
<body>
    ...
    <div class="container-fluid">
        <form class="d-flex" role="search">
            <input class="form-control me-2 search-input" type="search" placeholder="   تقيميك ..."
                aria-label="Search">
            <button class="btn btn-warning" type="submit">قيم</button>
        </form>
    </div>

    <section class="about-section">
        <p class="about-text">موجو هو مطعم في مِصر يقدم أكلات من المطبخ أمريكي ويوصل إلى التجمع الخامس - شركات التسعين - 2 و التجمع الخامس - الحي الاول.</p>
    </section>
    <!-- تكرار البطاقة -->
    <footer>
        <div class="container">
